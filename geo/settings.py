...
DATABASES = {
    'default': {
        ...
        'NAME': 'ddq0h6h0bh59pg',                      # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': 'idhmjmdcwiqnef',
        'PASSWORD': 'IzUjji-XW-yztWqeF5vhbqZ1Bt',
...
STATICFILES_DIRS = (
    os.path.join(os.path.dirname(__file__), "../geotour/static_files/"),
